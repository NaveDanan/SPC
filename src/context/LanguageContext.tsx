...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'ai.notConfigured': 'AI assistant is not configured. Please set VITE_AI_API_URL and VITE_AI_API_KEY.',
    'ai.configError': 'I could not reach the AI service because it is not configured. Please ask your administrator to set VITE_AI_API_URL and VITE_AI_API_KEY.',
  ...
  he: {
    ...
    'ai.notConfigured': 'עוזר ה-AI אינו מוגדר. נא להגדיר VITE_AI_API_URL ו-VITE_AI_API_KEY.',
    'ai.configError': 'לא הצלחתי להגיע לשירות ה-AI כי הוא לא מוגדר. בקש ממנהל המערכת להגדיר VITE_AI_API_URL ו-VITE_AI_API_KEY.',
