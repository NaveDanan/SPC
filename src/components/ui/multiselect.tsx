    ...
    return (
      ...
      >
        ...
        <div className="relative">
          <div
            className={cn(
              'absolute top-2 z-10 w-full overflow-hidden rounded-lg border border-gray-300 bg-white',
          ...
          >
            {open && (
              <CommandList
                className="bg-white text-gray-900 shadow-lg shadow-black/5 outline-none"
                onMouseLeave={() => {
